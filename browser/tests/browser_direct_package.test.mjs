...
test("browser direct adapter packs deterministically and works from a clean offline consumer", async (t) => {
  ...
  assert.equal(provenance.prerequisite.pullRequest, 23);
  assert.equal(provenance.prerequisite.commit, "16e17183ac20392e00f565492b5ccf067188f9fa");
  assert.equal(provenance.packagingLineage.pullRequest, 18);
  assert.equal(provenance.packagingLineage.commit, "256f670d832633159a3d91b9e4f522a438e966b4");
  ...
  assert.equal(provenance.providerSource.gitBlob, "56e418fca2f22fd6b3a836e332d0f055994046b4");
